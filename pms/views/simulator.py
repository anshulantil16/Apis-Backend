"""PMS Simulator — employee master, scoring, increments and exports.

This is the appraisal simulation itself. Letters live in offer_letters.py and
warning_letters.py.
"""
import io
import os
...
from .common import (BAND_ORDER, _BAND_IDX, _band_sort_key, _location_sort_key,
                     CTC_ANNUAL_MULT, _ann, _clip_to_field)
