...
class PMSTemplateView(APIView):
    def get(self, request):
        ...
        headers = [
            ...
            'Reporting Manager', 'Reporting ID', 'HOD Name', 'HOD ID', 'Span of Control',
            'Current CTC - 31-Mar-26 *', 'Current Variable Pay 31-Mar-26', 'Last Promotion (YR)', 'Years Not Promoted Before 2022',
            'FY 22-23 (CTC)', 'Increment 22-23', 'FY 22-23 (%)', 'FY 23-24 (CTC)', 'Increment 23-24', 'FY 23-24 (%)', 'FY 24-25 (CTC)', 'Increment 24-25', 'FY 24-25 (%)', 'FY 25-26 (Current CTC)',
        ...
        samples = [
            ...
            [1, 'EMP001', 'Rahul Sharma', 'Sales Manager', 'Sr Sales Manager', 'STAT',
             ...
             'Rajesh Kumar', 'MGR001', 'Priya Singh', 'HOD001', 5,
             50000, 8000, 2024, 0,
             600000, 50000, 3.5, 620000, 51667, 3.2, 640000, 53333, 3.1, 660000,
            ...
            [2, 'EMP002', 'Priya Singh', 'Sr Executive', '', 'MANAGER',
             ...
             'Ramesh Gupta', 'MGR002', 'Amit Kumar', 'HOD002', 8,
             40000, 6000, 2022, 2,
             450000, 40000, 4.0, 480000, 42667, 3.8, 510000, 45333, 3.5, 540000,
            ...
            [3, 'EMP003', 'Amit Kumar', 'Associate', '', '',
             ...
             'Vikram Singh', 'MGR003', 'Deepak Nair', 'HOD003', 3,
             25000, 2500, None, 2,
             280000, 23333, 2.8, 300000, 25000, 2.5, 320000, 26667, 2.2, 340000,
