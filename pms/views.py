...
class PMSImportView(APIView):
    ...
    def post(self, request):
        try:
            ...
            'age': 'age',
            'doj': 'date_of_joining',
            'tenure in apis as on 31st mar-2026': 'tenure_years',
            'reporting manager': 'reporting_manager',
            'reporting id': 'reporting_manager_id',
            'hod name': 'hod_name',
            'hod id': 'hod_id',
            'span of control': 'span_of_control',
            'current ctc- 31-mar-26': 'current_ctc',
            'current ctc - 31-mar-26': 'current_ctc',
            'current variable pay 31-mar-26': 'current_variable_pay',
            'last promotion (yr)': 'last_promotion_year',
            'years not promoted before 2022': 'years_not_promoted',
            'fy 22-23 (ctc)': 'fy_2223_ctc',
            'increment 22-23': 'fy_2223_increment',
            'fy 22-23 (%)': 'fy_2223_growth_pct',
            'fy 23-24 (ctc)': 'fy_2324_ctc',
            'increment 23-24': 'fy_2324_increment',
            'fy 23-24 (%)': 'fy_2324_growth_pct',
            'fy 24-25 (ctc)': 'fy_2425_ctc',
            ...
            'management discretion': 'management_discretion_pct',
            'one time reward': 'on_time_reward',
            're-designation': 'redesignation',
            ...
            'ctc fixedvariable': 'ctc_fixed',
            'ctc fixed': 'ctc_fixed',
            'variable': 'variable_pay',
            'fy 26-27 total ctc': 'new_ctc',
