...
class PMSImportView(APIView):
    ...
    def post(self, request):
        ...
        HEADER_ALIASES = {
            ...
            'employee id': 'employee_id', 'emp id': 'employee_id', 'empid': 'employee_id', 'er no': 'employee_id', 'employee id *': 'employee_id',
            'employee name': 'name', 'name': 'name', 'employee name *': 'name',
            'designation': 'designation', 'current designation': 'designation',
            'new designation': 'new_designation', 're-designation': 'new_designation', 're designation': 'new_designation', 'redesignation': 'new_designation',
            'type': 'new_designation_type', 'new designation type': 'new_designation_type', 'new employee type': 'new_designation_type',
            'department': 'department', 'dept': 'department',
            'new department': 'business',
            'new function': 'business',
            'zone': 'location', 'zone ': 'location',
            'sub zone': 'location', 'sub zone': 'location',
            ...
            'tenure in apis as on 31st mar-2026': 'tenure_years', 'tenure in apis as on 31-mar-2026': 'tenure_years', 'tenure in apis as on 31st mar 2026': 'tenure_years', 'tenure': 'tenure_years',
            ...
            'current ctc- 31-mar-26': 'current_ctc', 'current ctc - 31-mar-26': 'current_ctc', 'current ctc- 31-mar-26': 'current_ctc', 'current ctc - 31 mar 26': 'current_ctc', 'current ctc': 'current_ctc',
            'current variable pay 31-mar-26': 'current_variable_pay', 'current variable pay 31 mar 26': 'current_variable_pay',
            'last promotion (yr)': 'last_promotion_year', 'last promotion': 'last_promotion_year', 'last promotion yr': 'last_promotion_year',
            'years not promoted before 2022': 'years_not_promoted', 'years not promoted before 2022': 'years_not_promoted',
            'fy 22-23 (ctc)': 'fy_2223_ctc', 'fy 22-23 ctc': 'fy_2223_ctc', 'fy 2223 ctc': 'fy_2223_ctc', 'fy 22 23 ctc': 'fy_2223_ctc',
            'increment 22-23': 'fy_2223_increment', 'increment 22 23': 'fy_2223_increment',
            'fy 22-23 (%)': 'fy_2223_growth_pct', 'fy 22-23 %': 'fy_2223_growth_pct', 'fy 2223 growth %': 'fy_2223_growth_pct', 'fy 22 23 %': 'fy_2223_growth_pct',
            'fy 23-24 (ctc)': 'fy_2324_ctc', 'fy 23-24 ctc': 'fy_2324_ctc', 'fy 2324 ctc': 'fy_2324_ctc', 'fy 23 24 ctc': 'fy_2324_ctc',
            'increment 23-24': 'fy_2324_increment', 'increment 23 24': 'fy_2324_increment',
            'fy 23-24 (%)': 'fy_2324_growth_pct', 'fy 23-24 %': 'fy_2324_growth_pct', 'fy 2324 growth %': 'fy_2324_growth_pct', 'fy 23 24 %': 'fy_2324_growth_pct',
            'fy 24-25 (ctc)': 'fy_2425_ctc', 'fy 24-25 ctc': 'fy_2425_ctc', 'fy 2425 ctc': 'fy_2425_ctc', 'fy 24 25 ctc': 'fy_2425_ctc',
            'increment 24-25': 'fy_2425_increment', 'increment 24 25': 'fy_2425_increment',
            'fy 24-25 (%)': 'fy_2425_growth_pct', 'fy 24-25 %': 'fy_2425_growth_pct', 'fy 2425 growth %': 'fy_2425_growth_pct', 'fy 24 25 %': 'fy_2425_growth_pct',
            'fy 25-26 (current ctc)': 'current_ctc', 'fy 25-26 current ctc': 'current_ctc', 'fy 25-26(current ctc)': 'current_ctc', 'fy 25 26 current ctc': 'current_ctc',
            ...
            'promotion (y/n)': 'promoted', 'promotion': 'promoted', 'promotion y/n': 'promoted',
            'promotion rediness': 'promotion_readiness', 'promotion readiness': 'promotion_readiness', 'promotion_readiness': 'promotion_readiness',
            'level': 'level',
            ...
            're-designation': 'redesignation', 'redesignation': 'redesignation', 're designation': 'redesignation',
            'revised ctc': 'revised_ctc',
            'increment %': 'increment_pct',
            'promotion %': 'promotion_pct',
            'total hike %': 'total_impact_pct',
            'total salary increment': 'total_salary_increment', 'total  salary increment': 'total_salary_increment',
            'ctc fixed': 'ctc_fixed', 'ctcfixed': 'ctc_fixed', 'ctc fixedvariable': 'ctc_fixed',
            'variable': 'variable_pay', 'variable pay': 'variable_pay',
            'fy 26-27 total ctc': 'new_ctc', 'fy 26-27': 'new_ctc', 'fy 26 27 total ctc': 'new_ctc',
...
class PMSTemplateView(APIView):
    def get(self, request):
        ...
        widths = [8, 14, 18, 16, 16, 18, 14, 12, 20, 16, 12, 12, 16, 16, 10, 8, 8, 10, 14, 14, 10, 12, 14, 18, 12, 12, 14, 10, 14, 14, 14, 16, 14, 12, 14, 16, 14, 12, 14, 16, 14, 14, 14, 14, 12, 12, 12, 16, 16, 16, 18, 18, 20, 20]
