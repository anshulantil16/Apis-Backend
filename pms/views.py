    ...
    def get(self, request):
        ...
        samples = [
            [1, 'EMP001', 'Rahul Sharma', 'Sales Manager', 'Sr Sales Manager', 'STAT',
             ...
             50000, 10000, 2024, 0,
             600000, 48000, 650000, 52000, 700000, 56000, 720000,
             82, 85, 88, '80-90', '85-95',
             85, 'High', 'Yes', 'L2', '1_year',
             'Normal', 5, 'No', 'No',
             720000, 8, 8, 15, 110000,
             720000, 0, 830000,
            ...
            [2, 'EMP002', 'Priya Singh', 'Sr Executive', '', 'MANAGER',
             ...
             40000, 8000, 2022, 2,
             450000, 30150, 480000, 39600, 520000, 40040, 560000,
             88, 92, 90, '85-95', '90-100',
             92, 'Excellent', 'Yes', 'L1', 'ready_now',
             'High', 8, 'Yes', 'Yes',
             560000, 10, 10, 20, 120000,
             560000, 0, 680000,
            ...
            [3, 'EMP003', 'Amit Kumar', 'Associate', '', '',
             ...
             25000, 3000, None, 2,
             250000, 17500, 280000, 21000, 300000, 22500, 320000,
